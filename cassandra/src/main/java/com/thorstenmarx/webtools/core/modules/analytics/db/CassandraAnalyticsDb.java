...
import com.thorstenmarx.webtools.core.modules.analytics.db.index.cassandra.CassandraIndex;
 ...
 * @author marx
 */
public class CassandraAnalyticsDb extends AbstractAnalyticsDb<CassandraIndex> {

	private static final Logger LOGGER = LoggerFactory.getLogger(CassandraAnalyticsDb.class);
	 ...
	 */
	private CassandraIndex index = null;
	...
	public CassandraAnalyticsDb open() {
		this.isClosing = false;

		index = new CassandraIndex(configuration, session);
